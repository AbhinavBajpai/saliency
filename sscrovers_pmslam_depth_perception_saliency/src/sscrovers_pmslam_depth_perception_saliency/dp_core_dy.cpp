...
int main(int argc, char **argv)
{
  ...
  //ros::spin();
//! publishers
  dp_core->points3d_dp.onShutdown();

  //! subscribers
  dp_core->ptpairs_ds.onShutdown();
  dp_core->trajectory_ds.onShutdown();
  dp_core->features_db_ds.onShutdown();
  dp_core->features_ds.onShutdown();
