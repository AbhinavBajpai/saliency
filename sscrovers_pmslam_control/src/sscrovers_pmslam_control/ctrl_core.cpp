    ...
    it_(*_n)
{
  ...
  //private_node_handle.param("cam_pitch", camera_pitch_, double(0.0));
  //private_node_handle.param("cam_z", camera_z_, double(0.0));
  ...
  real_traj_pub_ = _n->advertise<nav_msgs::Path>(pub_real_traj_topic_name_.c_str(), 1);
  est_traj_pub_ = _n->advertise<nav_msgs::Path>(pub_est_traj_topic_name_.c_str(), 1);
  in_traj_pub_ = _n->advertise<nav_msgs::Path>(pub_in_traj_topic_name_.c_str(), 1);
  ctrl_vec_pub_ = _n->advertise<geometry_msgs::PoseStamped>(pub_ctrl_vec_topic_name_.c_str(), 1);
